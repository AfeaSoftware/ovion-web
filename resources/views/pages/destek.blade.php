  ...
  <div class="wrap">
    ...
    <div class="sp-contact-grid">
      ...
      <div class="sp-contact-card sp-reveal sp-reveal-d2">
        ...
        <a href="https://wa.me/905419104838" target="_blank" rel="noopener" class="btn btn-primary" style="height:40px; font-size:14px; padding:0 16px;">{{ __('ui.support_c3_cta') }}</a>
      </div>
