...
class PageContentSeeder extends Seeder
{
    ...
    {
        foreach ($this->homePayloads() as $locale => $content) {
        ...
        foreach ($this->aboutPayloads() as $locale => $content) {
            PageContent::updateOrCreate(
        ...
        foreach ($this->supportPayloads() as $locale => $content) {
            PageContent::updateOrCreate(
                ['type' => 'support', 'locale' => $locale],
                ['content' => $content],
            );
        }

        foreach ($this->accessoriesPayloads() as $locale => $content) {
            PageContent::updateOrCreate(
                ['type' => 'accessories', 'locale' => $locale],
                ['content' => $content],
            );
        }
    }
     ...
     */
    private function accessoriesPayloads(): array
    {
        return [
            'tr' => [
     ...
     * @return array<string, array<string, mixed>>
     */
    private function homePayloads(): array
    {
        return [
            'tr' => [
                'home_hero' => [
                ...
                'home_stats' => [
                    ...
                    ['value' => '81', 'suffix' => '', 'label' => 'İlde servis ağı'],
                    ['value' => '200', 'suffix' => '+', 'label' => 'Çalışan · İstanbul'],
                    ['value' => '2', 'suffix' => ' yıl', 'label' => 'Standart garanti'],
                ],
            ...
            'en' => [
                ...
                'home_stats' => [
                    ...
                    ['value' => '81', 'suffix' => '', 'label' => 'Cities with service'],
                    ['value' => '200', 'suffix' => '+', 'label' => 'Employees · Istanbul'],
                    ['value' => '2', 'suffix' => ' yr', 'label' => 'Standard warranty'],
                ],
     ...
     * @return array<string, array<string, mixed>>
     */
    private function aboutPayloads(): array
    {
        return [
            'tr' => [
                ...
                'values' => [
                    ['title' => 'Kalite', 'desc' => 'Bütçe dostu fiyat, ödün verilen kalite anlamına gelmez. Her V11 Lite, üretimden çıkmadan 120 noktalı kalite testinden geçer.'],
                    ['title' => 'Erişilebilirlik', 'desc' => 'İyi teknoloji, herkesin hayatına girmelidir. Ürünlerimizi Türkiye\'nin 81 ilinde servis ağı ve rekabetçi fiyatlarla sunuyoruz.'],
                    ['title' => 'İnovasyon', 'desc' => 'İstanbul tasarım merkezimizde 80\'den fazla AR-GE uzmanı, yarının ürünlerini bugün geliştiriyor. Patentli sensör ve kamera teknolojileri üzerinde çalışıyoruz.'],
                ],
                'made_eyebrow' => 'Üretim',
                ...
                'timeline' => [
                    ['year' => 'Oca 2023', 'title' => 'Ovion kuruldu', 'desc' => '7 kurucu ortak, İstanbul Teknopark\'ta Ovion\'u resmen kurdu. İlk ofis: 120 m², ilk ekip: 12 kişi.'],
                    ['year' => 'Haz 2023', 'title' => 'İlk üretim tesisi devreye girdi', 'desc' => 'Pendik\'teki fabrika, pilot üretim hattıyla faaliyete geçti. Aynı ay Sanayi Bakanlığı\'ndan yerli üretim sertifikası alındı.'],
                    ['year' => 'Mar 2024', 'title' => 'V11 Lite piyasaya çıktı', 'desc' => 'İlk ürünümüz V11 Lite, lansman gününde 10.000\'den fazla ön sipariş aldı. Ulusal basında geniş yer buldu.'],
                    ['year' => 'Eyl 2024', 'title' => 'Saat ve kulaklık AR-GE başladı', 'desc' => 'Wearable ürün ailesi için AR-GE yatırımı resmileşti. S serisi saat ve H serisi kulaklık projeleri başladı.'],
                    ['year' => 'Oca 2025', 'title' => 'S3 Pro saat tanıtıldı', 'desc' => 'AMOLED ekran, GPS ve 14 günlük pil ömrüyle S3 Pro, Türkiye\'nin en kapsamlı yerli akıllı saati oldu.'],
                    ['year' => '2026', 'title' => 'Genişleme — Orta Asya ve MENA', 'desc' => 'Kazakistan, Azerbaycan ve BAE dağıtım anlaşmalarıyla Ovion, sınırlarımızın ötesine taşınıyor.'],
                ],
            ...
            'en' => [
                ...
                'values' => [
                    ['title' => 'Quality', 'desc' => 'An affordable price does not mean compromised quality. Every V11 Lite passes a 120-point quality check before leaving the factory.'],
                    ['title' => 'Accessibility', 'desc' => 'Good technology should reach everyone. We offer our products with a service network spanning all 81 provinces of Türkiye at competitive prices.'],
                    ['title' => 'Innovation', 'desc' => 'Over 80 R&D specialists at our Istanbul design centre are building tomorrow\'s products today. We are working on patented sensor and camera technologies.'],
                ],
                ...
                'timeline' => [
                    ['year' => 'Jan 2023', 'title' => 'Ovion founded', 'desc' => '7 founding partners officially registered Ovion at Istanbul Technopark. First office: 120 m², first team: 12 people.'],
                    ['year' => 'Jun 2023', 'title' => 'First production facility launched', 'desc' => 'The Pendik factory went live with its pilot production line. That same month, a domestic production certificate was received from the Ministry of Industry.'],
                    ['year' => 'Mar 2024', 'title' => 'V11 Lite launched', 'desc' => 'Our first product, the V11 Lite, received over 10,000 pre-orders on launch day and was widely covered in the national press.'],
                    ['year' => 'Sep 2024', 'title' => 'Watch & headphone R&D begins', 'desc' => 'R&D investment for the wearable product family was formalised. The S-series watch and H-series headphone projects kicked off.'],
                    ['year' => 'Jan 2025', 'title' => 'S3 Pro watch unveiled', 'desc' => 'With an AMOLED display, GPS and 14-day battery life, the S3 Pro became Türkiye\'s most comprehensive domestic smartwatch.'],
                    ['year' => '2026', 'title' => 'Expansion — Central Asia & MENA', 'desc' => 'Distribution deals in Kazakhstan, Azerbaijan and the UAE take Ovion beyond its borders.'],
                ],
     ...
     * @return array<string, array<string, mixed>>
     */
    private function supportPayloads(): array
    {
        return [
            'tr' => [
                'hero_eyebrow' => 'Destek',
                ...
                'quick_actions' => [
                    ['icon' => 'shield', 'title' => 'Garanti Sorgula', 'desc' => 'Seri numaranızla garanti durumunuzu anında öğrenin.', 'cta' => 'Sorgula', 'url' => '#garanti'],
                    ['icon' => 'wrench', 'title' => 'Servis Talebi Oluştur', 'desc' => 'Cihazınız için yetkili servis randevusu alın.', 'cta' => 'Talep Oluştur', 'url' => '#servis'],
                    ['icon' => 'book', 'title' => 'Kullanım Kılavuzları', 'desc' => 'V11 Lite, S3 Pro ve tüm ürünler için PDF kılavuzlar.', 'cta' => 'İndir', 'url' => '#kilavuz'],
                    ['icon' => 'question', 'title' => 'Sıkça Sorulan Sorular', 'desc' => 'En çok sorulan soruların cevapları burada.', 'cta' => 'Görüntüle', 'url' => '#faq'],
                    ['icon' => 'chat', 'title' => 'Canlı Destek', 'desc' => 'Hafta içi 09:00–18:00 arasında bir uzmanla konuşun.', 'cta' => 'Başlat', 'url' => '#iletisim'],
                    ['icon' => 'pin', 'title' => 'Bayi ve Servis Bul', 'desc' => 'Yakınızdaki yetkili bayi ve servis merkezlerini bulun.', 'cta' => 'Haritada Gör', 'url' => '#servis'],
                ],
            ...
            'en' => [
                ...
                'quick_actions' => [
                    ['icon' => 'shield', 'title' => 'Check Warranty', 'desc' => 'Find your warranty status instantly with your serial number.', 'cta' => 'Check', 'url' => '#garanti'],
                    ['icon' => 'wrench', 'title' => 'Create Service Request', 'desc' => 'Book an authorised service appointment for your device.', 'cta' => 'Create Request', 'url' => '#servis'],
                    ['icon' => 'book', 'title' => 'User Manuals', 'desc' => 'PDF manuals for V11 Lite, S3 Pro and all products.', 'cta' => 'Download', 'url' => '#kilavuz'],
                    ['icon' => 'question', 'title' => 'Frequently Asked Questions', 'desc' => 'Answers to the most common questions, right here.', 'cta' => 'View', 'url' => '#faq'],
                    ['icon' => 'chat', 'title' => 'Live Support', 'desc' => 'Talk to a specialist weekdays 09:00–18:00.', 'cta' => 'Start', 'url' => '#iletisim'],
                    ['icon' => 'pin', 'title' => 'Find Dealer & Service', 'desc' => 'Find the nearest authorised dealer and service centre.', 'cta' => 'Show on Map', 'url' => '#servis'],
                ],
                ...
                'service_steps' => [
                    ['title' => 'Create Request', 'desc' => 'Create a service request via web or app. Briefly describe your issue.'],
                    ['title' => 'Drop-off or Courier', 'desc' => 'Drop your device off at the nearest service centre or send it by courier; round-trip delivery is free.'],
                    ['title' => 'Diagnosis and Repair', 'desc' => 'Our expert technicians inspect the device, send you a diagnostic report and start the repair upon your approval.'],
                    ['title' => 'Delivery', 'desc' => 'On average within 3 business days, your device is delivered to your door. The process can be tracked via SMS and email.'],
                ],
